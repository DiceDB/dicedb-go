...
type Metadata struct {
	...
	IsWatchable   bool                   `protobuf:"varint,1,opt,name=isWatchable,proto3" json:"isWatchable,omitempty"` // Unix timestamp when response was generated
...
func (x *Metadata) GetIsWatchable() bool {
	if x != nil {
		return x.IsWatchable
	}
	return false
}
...
type Result struct {
	...
	Metadata      *Metadata              `protobuf:"bytes,4,opt,name=metadata,proto3,oneof" json:"metadata,omitempty"` // Added metadata field
...
const file_protos_res_proto_rawDesc = "" +
	"\n" +
	"\x10protos/res.proto\x12\x04wire\",\n" +
	"\bMetadata\x12 \n" +
	"\visWatchable\x18\x01 \x01(\bR\visWatchable\"\xf8\x10\n" +
	"\x06Result\x12$\n" +
	"\x06status\x18\x01 \x01(\x0e2\f.wire.StatusR\x06status\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12$\n" +
	"\rfingerprint64\x18\x03 \x01(\x04R\rfingerprint64\x12/\n" +
	"\bmetadata\x18\x04 \x01(\v2\x0e.wire.MetadataH\x01R\bmetadata\x88\x01\x01\x12)\n" +
	...
	"\rZRANKWATCHRes\x182 \x01(\v2\x13.wire.ZRANKWATCHResH\x00R\rZRANKWATCHResB\n" +
	"\n" +
	"\bresponseB\v\n" +
	"\t_metadata\"\x0f\n" +
	"\rZRANKWATCHRes\"\x0e\n" +
...
var file_protos_res_proto_msgTypes = make([]protoimpl.MessageInfo, 44)
var file_protos_res_proto_goTypes = []any{
	(Status)(0),             // 0: wire.Status
	(*Metadata)(nil),        // 1: wire.Metadata
	(*Result)(nil),          // 2: wire.Result
	(*ZRANKWATCHRes)(nil),   // 3: wire.ZRANKWATCHRes
	(*HGETWATCHRes)(nil),    // 4: wire.HGETWATCHRes
	(*HGETALLWATCHRes)(nil), // 5: wire.HGETALLWATCHRes
	(*GETWATCHRes)(nil),     // 6: wire.GETWATCHRes
	(*UNWATCHRes)(nil),      // 7: wire.UNWATCHRes
	(*ZADDRes)(nil),         // 8: wire.ZADDRes
	(*ZCOUNTRes)(nil),       // 9: wire.ZCOUNTRes
	(*TYPERes)(nil),         // 10: wire.TYPERes
	(*PINGRes)(nil),         // 11: wire.PINGRes
	(*HGETRes)(nil),         // 12: wire.HGETRes
	(*HSETRes)(nil),         // 13: wire.HSETRes
	(*HElement)(nil),        // 14: wire.HElement
	(*HGETALLRes)(nil),      // 15: wire.HGETALLRes
	(*TTLRes)(nil),          // 16: wire.TTLRes
	(*EXPIRERes)(nil),       // 17: wire.EXPIRERes
	(*EXPIREATRes)(nil),     // 18: wire.EXPIREATRes
	(*EXPIRETIMERes)(nil),   // 19: wire.EXPIRETIMERes
	(*ECHORes)(nil),         // 20: wire.ECHORes
	(*EXISTSRes)(nil),       // 21: wire.EXISTSRes
	(*HANDSHAKERes)(nil),    // 22: wire.HANDSHAKERes
	(*GETRes)(nil),          // 23: wire.GETRes
	(*GETEXRes)(nil),        // 24: wire.GETEXRes
	(*GETSETRes)(nil),       // 25: wire.GETSETRes
	(*GETDELRes)(nil),       // 26: wire.GETDELRes
	(*SETRes)(nil),          // 27: wire.SETRes
	(*DELRes)(nil),          // 28: wire.DELRes
	(*FLUSHDBRes)(nil),      // 29: wire.FLUSHDBRes
	(*KEYSRes)(nil),         // 30: wire.KEYSRes
	(*INCRRes)(nil),         // 31: wire.INCRRes
	(*DECRRes)(nil),         // 32: wire.DECRRes
	(*INCRBYRes)(nil),       // 33: wire.INCRBYRes
	(*DECRBYRes)(nil),       // 34: wire.DECRBYRes
	(*ZElement)(nil),        // 35: wire.ZElement
	(*ZRANGERes)(nil),       // 36: wire.ZRANGERes
	(*ZPOPMAXRes)(nil),      // 37: wire.ZPOPMAXRes
	(*ZREMRes)(nil),         // 38: wire.ZREMRes
	(*ZPOPMINRes)(nil),      // 39: wire.ZPOPMINRes
	(*ZRANKRes)(nil),        // 40: wire.ZRANKRes
	(*ZCARDRes)(nil),        // 41: wire.ZCARDRes
	(*ZRANGEWATCHRes)(nil),  // 42: wire.ZRANGEWATCHRes
	(*ZCOUNTWATCHRes)(nil),  // 43: wire.ZCOUNTWATCHRes
	(*ZCARDWATCHRes)(nil),   // 44: wire.ZCARDWATCHRes
}
var file_protos_res_proto_depIdxs = []int32{
	0,  // 0: wire.Result.status:type_name -> wire.Status
	1,  // 1: wire.Result.metadata:type_name -> wire.Metadata
	10, // 2: wire.Result.TYPERes:type_name -> wire.TYPERes
	11, // 3: wire.Result.PINGRes:type_name -> wire.PINGRes
	20, // 4: wire.Result.ECHORes:type_name -> wire.ECHORes
	22, // 5: wire.Result.HANDSHAKERes:type_name -> wire.HANDSHAKERes
	21, // 6: wire.Result.EXISTSRes:type_name -> wire.EXISTSRes
	23, // 7: wire.Result.GETRes:type_name -> wire.GETRes
	27, // 8: wire.Result.SETRes:type_name -> wire.SETRes
	28, // 9: wire.Result.DELRes:type_name -> wire.DELRes
	30, // 10: wire.Result.KEYSRes:type_name -> wire.KEYSRes
	26, // 11: wire.Result.GETDELRes:type_name -> wire.GETDELRes
	24, // 12: wire.Result.GETEXRes:type_name -> wire.GETEXRes
	25, // 13: wire.Result.GETSETRes:type_name -> wire.GETSETRes
	31, // 14: wire.Result.INCRRes:type_name -> wire.INCRRes
	32, // 15: wire.Result.DECRRes:type_name -> wire.DECRRes
	33, // 16: wire.Result.INCRBYRes:type_name -> wire.INCRBYRes
	34, // 17: wire.Result.DECRBYRes:type_name -> wire.DECRBYRes
	29, // 18: wire.Result.FLUSHDBRes:type_name -> wire.FLUSHDBRes
	17, // 19: wire.Result.EXPIRERes:type_name -> wire.EXPIRERes
	18, // 20: wire.Result.EXPIREATRes:type_name -> wire.EXPIREATRes
	19, // 21: wire.Result.EXPIRETIMERes:type_name -> wire.EXPIRETIMERes
	16, // 22: wire.Result.TTLRes:type_name -> wire.TTLRes
	6,  // 23: wire.Result.GETWATCHRes:type_name -> wire.GETWATCHRes
	7,  // 24: wire.Result.UNWATCHRes:type_name -> wire.UNWATCHRes
	12, // 25: wire.Result.HGETRes:type_name -> wire.HGETRes
	13, // 26: wire.Result.HSETRes:type_name -> wire.HSETRes
	15, // 27: wire.Result.HGETALLRes:type_name -> wire.HGETALLRes
	4,  // 28: wire.Result.HGETWATCHRes:type_name -> wire.HGETWATCHRes
	5,  // 29: wire.Result.HGETALLWATCHRes:type_name -> wire.HGETALLWATCHRes
	8,  // 30: wire.Result.ZADDRes:type_name -> wire.ZADDRes
	9,  // 31: wire.Result.ZCOUNTRes:type_name -> wire.ZCOUNTRes
	36, // 32: wire.Result.ZRANGERes:type_name -> wire.ZRANGERes
	37, // 33: wire.Result.ZPOPMAXRes:type_name -> wire.ZPOPMAXRes
	38, // 34: wire.Result.ZREMRes:type_name -> wire.ZREMRes
	39, // 35: wire.Result.ZPOPMINRes:type_name -> wire.ZPOPMINRes
	40, // 36: wire.Result.ZRANKRes:type_name -> wire.ZRANKRes
	41, // 37: wire.Result.ZCARDRes:type_name -> wire.ZCARDRes
	42, // 38: wire.Result.ZRANGEWATCHRes:type_name -> wire.ZRANGEWATCHRes
	43, // 39: wire.Result.ZCOUNTWATCHRes:type_name -> wire.ZCOUNTWATCHRes
	44, // 40: wire.Result.ZCARDWATCHRes:type_name -> wire.ZCARDWATCHRes
	3,  // 41: wire.Result.ZRANKWATCHRes:type_name -> wire.ZRANKWATCHRes
	14, // 42: wire.HGETALLRes.elements:type_name -> wire.HElement
	35, // 43: wire.ZRANGERes.elements:type_name -> wire.ZElement
	35, // 44: wire.ZPOPMAXRes.elements:type_name -> wire.ZElement
	35, // 45: wire.ZPOPMINRes.elements:type_name -> wire.ZElement
	35, // 46: wire.ZRANKRes.element:type_name -> wire.ZElement
